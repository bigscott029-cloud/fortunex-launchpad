...
import { BadgeCheck, Clock3, CreditCard, Flame, PlayCircle, ShieldCheck } from "lucide-react";
...
const pulseItems = [
  ...
  },
  {
    ...
    message: "Choose between ₦20,000 and ₦14,000 packages — both include withdrawal access.",
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    icon: DollarSign,
    title: "Blessing A.",
    message: "Started with the ₦20,000 promo and made back my money in 11 days. Thank you Glamour!",
  },
  {
    icon: Star,
    title: "Tunde K.",
  ...
  },
  {
    icon: UserCheck,
    title: "Funke P.",
    message: "Registered for the ₦20k package yesterday. Onboarding was seamless.",
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    icon: Award,
    title: "Oluwatosin J.",
    message: "Upgraded to the ₦20,000 package. The value is insane. Worth every kobo.",
  },
  {
    icon: Users,
      ...
      <div className="pointer-events-auto rounded-2xl border border-gold/30 bg-background/95 p-4 shadow-gold backdrop-blur-md">
        <div className="flex gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gold/15">
            <activeItem.icon className="h-5 w-5 text-gold" />
          </div>
          <div>
